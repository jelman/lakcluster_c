...
mc_A_alt_ = mc_A_ori_; 
% mc_A_alt_(1:2:20)=0; %<-- remove a few cols. ;
if (flag_verbose); disp(sprintf(' %% ;')); end;
...
subplot(1,2,1);
hold on;
plot(trace__.niter_s0000_,trace__.ZR_is__,'k-','LineWidth',linewidth_sml, 'Color', [0 0 0 0.3]); 
...
plot(r_rem_max-trace__.r_rem_s0000_,trace__.ZR_is__,'k-','LineWidth',linewidth_sml, 'Color', [0 0 0 0.3]);
