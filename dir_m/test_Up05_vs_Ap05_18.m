...
ncontinent = 0; %<-- Assumes continents labels are 1-based. If not, see notes when defining mr_A_alt_trn_ and mr_Z_alt_trn_ below;
if (flag_verbose); disp(sprintf(' %% ;')); end;
...
axis equal; axis vis3d;
%%%%;
fname_fig = sprintf('/%s/r/dir_Up05/Up05_DandX_p01_FIGA',dir_trunk);
print('-djpeg',sprintf('%s.jpg',fname_fig));
print('-depsc',sprintf('%s.eps',fname_fig));
end;%if flag_disp;
%%%%%%%%;
