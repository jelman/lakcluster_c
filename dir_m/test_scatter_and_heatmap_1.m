...
if ~isfield(parameter,'min_prctile'); parameter.min_prctile =   0; end;
min_prctile = parameter.min_prctile;
if ~isfield(parameter,'max_prctile'); parameter.max_prctile = 100; end;
max_prctile = parameter.max_prctile;
...
AZnV_0_min = prctile(AZnV_pr__(1+tmp_index_,1+0),min_prctile); AZnV_0_max = prctile(AZnV_pr__(1+tmp_index_,1+0),max_prctile);
...
AZnV_1_min = prctile(AZnV_pr__(1+tmp_index_,1+1),min_prctile); AZnV_1_max = prctile(AZnV_pr__(1+tmp_index_,1+1),max_prctile);
...
xtickangle(45); set(gca,'FontSize',fontsize_use);
xlabel('PC1'); ylabel('PC2');
%%%%%%%%;

%%%%%%%%;
subplot_{2} = subplot(1,2,2); cla;
