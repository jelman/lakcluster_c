...
p_iter0_out = exp(z_to_lp(trace__.ZR_s0000_(1)));
disp(sprintf('p_avg_out %0.3f p_top_out %0.3f p_all_out %0.3f p_iter0_out %0.3f',p_avg_out,p_top_out,p_all_out,p_iter0_out));
...
xline(niter_i_(parameter.niteration_alo), 'b--');
xline(niter_i_(parameter.niteration_ahi), 'b--');
hold off;
...
xline(tmp_r_eli_i_(parameter.niteration_alo), 'b--');
xline(tmp_r_eli_i_(parameter.niteration_ahi), 'b--');
hold off;
...
title(sprintf('p_avg_out %0.6f p_top_out %0.6f p_all_out %0.6f p_iter0_out %0.6f',p_avg_out,p_top_out,p_all_out,p_iter0_out),'Interpreter','none');
