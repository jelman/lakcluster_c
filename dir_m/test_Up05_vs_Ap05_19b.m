...
tmp_t = tic(); if (flag_verbose); disp(sprintf(' %% unique ...')); end;
[ ...
 dataset_{1+ndataset_Ap05}.u_bim_vid_ ...
,dataset_{1+ndataset_Ap05}.ij_nvid_from_nbim_ ...
,dataset_{1+ndataset_Ap05}.ij_nbim_from_nvid_ ...
] = ...
unique(dataset_{1+ndataset_Ap05}.bim_vid_,'stable');
tmp_t = toc(tmp_t); if (flag_verbose); disp(sprintf(' %% unique: %0.6fs',tmp_t)); end;
%%%%%%%%;
dataset_{1+ndataset_Ap05}.n_u_bim_vid = numel(dataset_{1+ndataset_Ap05}.u_bim_vid_);
dataset_{1+ndataset_Ap05}.ij_nbim_from_nvid__ = sparse(dataset_{1+ndataset_Ap05}.ij_nbim_from_nvid_,1:dataset_{1+ndataset_Ap05}.n_snp,1,dataset_{1+ndataset_Ap05}.n_u_bim_vid,dataset_{1+ndataset_Ap05}.n_snp);
%%%%%%%%;

%%%%%%%%;
tmp_t = tic(); if (flag_verbose); disp(sprintf(' %% intersect ...')); end;
[cap_Up05_u_bim_vid_kunkle_vid_,ij_Up05_u_bim_vid_from_cap_,ij_kunkle_vid_from_cap_] = intersect(dataset_{1+ndataset_Up05}.u_bim_vid_,kunkle_vid_,'stable');
tmp_t = toc(tmp_t); if (flag_verbose); disp(sprintf(' %% intersect: %0.6fs',tmp_t)); end;
cap_Up05_u_bim_vid_kunkle_vid_ADp_ = kunkle_ADp_(ij_kunkle_vid_from_cap_);
Up05_u_bim_vid_ADp_ = ones(dataset_{1+ndataset_Up05}.n_u_bim_vid,1);
Up05_u_bim_vid_ADp_(ij_Up05_u_bim_vid_from_cap_) = cap_Up05_u_bim_vid_kunkle_vid_ADp_;
%%%%%%%%;
tmp_t = tic(); if (flag_verbose); disp(sprintf(' %% intersect ...')); end;
[cap_Ap05_u_bim_vid_kunkle_vid_,ij_Ap05_u_bim_vid_from_cap_,ij_kunkle_vid_from_cap_] = intersect(dataset_{1+ndataset_Ap05}.u_bim_vid_,kunkle_vid_,'stable');
tmp_t = toc(tmp_t); if (flag_verbose); disp(sprintf(' %% intersect: %0.6fs',tmp_t)); end;
cap_Ap05_u_bim_vid_kunkle_vid_ADp_ = kunkle_ADp_(ij_kunkle_vid_from_cap_);
Ap05_u_bim_vid_ADp_ = ones(dataset_{1+ndataset_Ap05}.n_u_bim_vid,1);
Ap05_u_bim_vid_ADp_(ij_Ap05_u_bim_vid_from_cap_) = cap_Ap05_u_bim_vid_kunkle_vid_ADp_;
%%%%%%%%;

n_test = 8;
for ntest=0:n_test-1;
n_cap = numel(cap_Up05_u_bim_vid_kunkle_vid_);
ncap = max(0,min(n_cap-1,floor(n_cap*ntest/n_test)));
tmp_kunkle_vid = kunkle_vid_{ij_kunkle_vid_from_cap_(1+ncap)};
tmp_u_bim_vid = dataset_{1+ndataset_Up05}.u_bim_vid_{ij_Up05_u_bim_vid_from_cap_(1+ncap)};
tmp_kunkle_ADp = kunkle_ADp_(ij_kunkle_vid_from_cap_(1+ncap));
tmp_Up05_u_bim_vid_ADp = Up05_u_bim_vid_ADp_(ij_Up05_u_bim_vid_from_cap_(1+ncap));
assert(strcmp(tmp_kunkle_vid,tmp_u_bim_vid));
assert(tmp_kunkle_ADp==tmp_Up05_u_bim_vid_ADp);
if (flag_verbose); disp(sprintf(' %% ntest %d/%d: %s vs %s, %0.4f vs %0.4f',ntest,n_test,tmp_kunkle_vid,tmp_u_bim_vid,tmp_kunkle_ADp,tmp_Up05_u_bim_vid_ADp)); end;
end;%for ntest=0:n_test-1;

Up05_bim_ADp_ = transpose(dataset_{1+ndataset_Up05}.ij_nbim_from_nvid__)*Up05_u_bim_vid_ADp_;
Ap05_bim_ADp_ = transpose(dataset_{1+ndataset_Ap05}.ij_nbim_from_nvid__)*Ap05_u_bim_vid_ADp_;

%%%%%%%%;
% And now we finally have a usable array Up05_bim_ADp_, where: ;
% Up05_bim_ADp_(1+nsnp) is the AD-p-value associated with dataset_{1+ndataset_Up05}.bim_vid_{1+nsnp}. ;
%%%%%%%%;
n_test = 8;
for ntest=0:n_test-1;
nsnp = max(0,min(dataset_{1+ndataset_Up05}.n_snp,floor(dataset_{1+ndataset_Up05}.n_snp*ntest/n_test)));
tmp_u_bim_vid = dataset_{1+ndataset_Up05}.bim_vid_{1+nsnp};
tmp_Up05_bim_ADp = Up05_bim_ADp_(1+nsnp);
if (tmp_Up05_bim_ADp< 1);
nk = efind(strcmp(kunkle_vid_,tmp_u_bim_vid));
tmp_kunkle_vid = kunkle_vid_{1+nk};
tmp_kunkle_ADp = kunkle_ADp_(1+nk);
if (flag_verbose); disp(sprintf(' %% ntest %d/%d: %s vs %s, %0.4f vs %0.4f',ntest,n_test,tmp_kunkle_vid,tmp_u_bim_vid,tmp_kunkle_ADp,tmp_Up05_bim_ADp)); end;
assert(strcmp(tmp_kunkle_vid,tmp_u_bim_vid));
assert(tmp_kunkle_ADp==tmp_Up05_bim_ADp);
end;%if (tmp_Up05_bim_ADp< 1);
end;%for ntest=0:n_test-1;
%%%%%%%%;
if (flag_verbose); disp(sprintf(' %% numel(intersect(dataset_{1+ndataset_Up05}.bim_vid_(1+efind(Up05_bim_ADp_<=0.05)),dataset_{1+ndataset_Up05}.bim_vid_)): %d/%d',numel(intersect(dataset_{1+ndataset_Up05}.bim_vid_(1+efind(Up05_bim_ADp_<=0.05)),dataset_{1+ndataset_Up05}.bim_vid_)),numel(unique(dataset_{1+ndataset_Up05}.bim_vid_)))); end;
%%%%%%%%;

%%%%%%%%;
% Similarly, we have a usable array Ap05_bim_ADp_, where: ;
% Ap05_bim_ADp_(1+nsnp) is the AD-p-value associated with dataset_{1+ndataset_Ap05}.bim_vid_{1+nsnp}. ;
%%%%%%%%;
n_test = 8;
for ntest=0:n_test-1;
nsnp = max(0,min(dataset_{1+ndataset_Ap05}.n_snp,floor(dataset_{1+ndataset_Ap05}.n_snp*ntest/n_test)));
tmp_u_bim_vid = dataset_{1+ndataset_Ap05}.bim_vid_{1+nsnp};
tmp_Ap05_bim_ADp = Ap05_bim_ADp_(1+nsnp);
if (tmp_Ap05_bim_ADp< 1);
nk = efind(strcmp(kunkle_vid_,tmp_u_bim_vid));
tmp_kunkle_vid = kunkle_vid_{1+nk};
tmp_kunkle_ADp = kunkle_ADp_(1+nk);
if (flag_verbose); disp(sprintf(' %% ntest %d/%d: %s vs %s, %0.4f vs %0.4f',ntest,n_test,tmp_kunkle_vid,tmp_u_bim_vid,tmp_kunkle_ADp,tmp_Ap05_bim_ADp)); end;
assert(strcmp(tmp_kunkle_vid,tmp_u_bim_vid));
assert(tmp_kunkle_ADp==tmp_Ap05_bim_ADp);
end;%if (tmp_Ap05_bim_ADp< 1);
end;%for ntest=0:n_test-1;
%%%%%%%%;
if (flag_verbose); disp(sprintf(' %% numel(intersect(dataset_{1+ndataset_Ap05}.bim_vid_(1+efind(Ap05_bim_ADp_<=0.05)),dataset_{1+ndataset_Ap05}.bim_vid_)): %d/%d',numel(intersect(dataset_{1+ndataset_Ap05}.bim_vid_(1+efind(Ap05_bim_ADp_<=0.05)),dataset_{1+ndataset_Ap05}.bim_vid_)),numel(unique(dataset_{1+ndataset_Ap05}.bim_vid_)))); end;
%%%%%%%%;
...
%%%%%%%%;
% Now we calculate the principal-component projections of Up05 ;
% using the snps in allele_cap_. ;
% Note that this is not the projection that we want to show when ;
% analyzing Up05 initially, since it involves the replication ;
% dataset Ap05 (i.e., Ap05 helps determine what snps are in allele_cap_). ;
...
mx_Up05__ = dataset_{1+ndataset_Up05}.mx__;
...
%%%%;
dir_trunk_Ap05 = sprintf('%s/dir_Ap05',dir_trunk);
mx_Ap05__ = dataset_{1+ndataset_Ap05}.mx__;
parameter_Ap05.dir_code = dir_code;
parameter_Ap05.dir_trunk = dir_trunk_Ap05;
parameter_Ap05.str_lak_vs_dex = str_lak_vs_dex;
parameter_Ap05.str_prefix = str_prefix;
parameter_Ap05.gamma = gamma;
parameter_Ap05.n_mds = n_mds_0in;
parameter_Ap05.n_mds_repl = n_mds_repl;
parameter_Ap05.ij_mds_use_ = ij_mds_use_;
parameter_Ap05.flag_force_create = 0; %<-- reload previous run. ;
parameter_Ap05.flag_verbose = max(0,flag_verbose-1);
parameter_Ap05.maf_lo_threshold = maf_lo_threshold;
parameter_Ap05.n_shuffle = 128;
parameter_Ap05.dir_0in = sprintf('%s/dir_%s',parameter_Ap05.dir_trunk,parameter_Ap05.str_prefix);
parameter_Ap05.nshuffle = 0;
%%%%%%%%;
pca_rank = 2;
...
AZnV_DandX_trnUp05_tstAp05_txx_p01_pnt___ = zeros(dataset_{1+ndataset_Up05}.n_patient,pca_rank,n_p_threshold);
AZnV_DandX_Ap05_from_trnUp05_tstAp05_txx_p01_p01_pnt___ = zeros(dataset_{1+ndataset_Ap05}.n_patient,pca_rank,n_p_threshold);
...
pca_mr_A_Up05_ = { 1*mx_Up05__.mr_A_full_ + 1*mx_Up05__.mr_Z_full_ };
pca_mr_Z_Up05_ = { 0*mx_Up05__.mr_A_full_ + 0*mx_Up05__.mr_Z_full_ };
pca_mc_A_Up05 = mx_Up05__.mc_A_;
tmp_mc_ = zeros(dataset_{1+ndataset_Up05}.n_snp,1);
tmp_mc_(1+efind(Up05_bim_ADp_<=p_threshold))=1;
pca_mc_A_Up05 = pca_mc_A_Up05.*tmp_mc_;
pca_mc_A_Up05(1+index_Up05_setminus_cap_) = 0; %<-- now turn off the allele-combinations not in allele_cap_. ;
pca_str_infix_Up05=sprintf('trnUp05_tstAp05_t%s_DandX_p01',str_p_threshold);
parameter_DandX_trnUp05_tstAp05_txx_p01 = parameter_Up05;
parameter_DandX_trnUp05_tstAp05_txx_p01.flag_force_create = 0;
parameter_DandX_trnUp05_tstAp05_txx_p01.str_A_p = str_Up05_A_p_p01;
parameter_DandX_trnUp05_tstAp05_txx_p01.str_name_s0000 = sprintf('pca_trnUp05_tstAp05_t%s_DandX_p01',str_p_threshold);
tmp_t = tic(); if (flag_verbose); disp(sprintf(' %% xxxcluster_fromdisk_uADZSZDA_pca_D_from_mx_ver16 ...')); end;
[ ...
 parameter_DandX_trnUp05_tstAp05_txx_p01 ...
,tmp_AZnV_DandX_trnUp05_tstAp05_txx_p01_ ...
,tmp_AnV_DandX_trnUp05_tstAp05_txx_p01_ ...
,tmp_ZnV_DandX_trnUp05_tstAp05_txx_p01_ ...
,tmp_V_DandX_trnUp05_tstAp05_txx_p01_ ...
] = ...
...
AZnV_DandX_trnUp05_tstAp05_txx_p01_pnt___(:,:,1+np_threshold) = tmp_AZnV_DandX_trnUp05_tstAp05_txx_p01_;
%%%%%%%%;
% Now at this stage parameter_DandX_trnUp05_tstAp05_txx_p01 has the appropriate paths. ;
% This allows us to use these paths to project Ap05 data onto the principal-components defined using the Up05 data. ;
% Note that we have to use those principal-components defined using the intersection ;
% of the Up05 data with the allele_cap (see pca_str_infix_Ap05 later on below). ;
%%%%%%%%;
pca_mr_A_Ap05_ = { 1*mx_Ap05__.mr_A_full_ + 1*mx_Ap05__.mr_Z_full_ };
pca_mr_Z_Ap05_ = { 0*mx_Ap05__.mr_A_full_ + 0*mx_Ap05__.mr_Z_full_ };
pca_mc_A_Ap05 = mx_Ap05__.mc_A_;
tmp_mc_ = zeros(dataset_{1+ndataset_Ap05}.n_snp,1);
tmp_mc_(1+efind(Ap05_bim_ADp_<=p_threshold))=1;
pca_mc_A_Ap05 = pca_mc_A_Ap05.*tmp_mc_;
pca_mc_A_Ap05(1+index_Ap05_setminus_cap_) = 0; %<-- now turn off the allele-combinations not in allele_cap_. ;
%pca_str_infix_Ap05=sprintf('Ap05_from_trnUp05_tstAp05_t%s_DandX_p01',str_p_threshold); %<-- unused, see below. ;
parameter_DandX_Ap05_from_trnUp05_tstAp05_txx_p01 = parameter_Ap05;
parameter_DandX_Ap05_from_trnUp05_tstAp05_txx_p01.flag_force_create = 0;
parameter_DandX_Ap05_from_trnUp05_tstAp05_txx_p01.str_A_p = str_Ap05_A_p_p01;
parameter_DandX_Ap05_from_trnUp05_tstAp05_txx_p01.str_name_s0000 = sprintf('pca_Ap05_from_trnUp05_tstAp05_t%s_DandX_p01',str_p_threshold);
%%%%;
pca_str_infix_Ap05=sprintf('trnUp05_tstAp05_t%s_DandX_p01',str_p_threshold); %<-- this defines the pca file to use. ;
parameter_DandX_trnUp05_tstAp05_txx_p01.str_V_ = sprintf('%s/dir_pca/dir_pca_mda/pca_D_%s_k%d_B44_V_.mda',parameter_DandX_trnUp05_tstAp05_txx_p01.dir_out_s0000,pca_str_infix_Ap05,pca_rank);
if ~exist(parameter_DandX_trnUp05_tstAp05_txx_p01.str_V_,'file');
disp(sprintf(' %% Warning, %s not found',parameter_DandX_trnUp05_tstAp05_txx_p01.str_V_));
end;%if ~exist(parameter_DandX_trnUp05_tstAp05_txx_p01.str_V_,'file');
DandX_trnUp05_tstAp05_txx_p01_V_ = mda_read_r8(parameter_DandX_trnUp05_tstAp05_txx_p01.str_V_);
if (flag_verbose); disp(sprintf(' %% size of intersection: %d',numel(index_Up05_from_cap_))); end;
if (flag_verbose); disp(sprintf(' %% Support of V_: %d',sum(abs(DandX_trnUp05_tstAp05_txx_p01_V_(:,1))>0))); end;
if (flag_verbose); disp(sprintf(' %% intersection of supp(V_) with cap: %d',numel(intersect(index_Up05_from_cap_,efind(abs(DandX_trnUp05_tstAp05_txx_p01_V_(:,1))>0))))); end;
DandX_Ap05_from_trnUp05_tstAp05_txx_p01_V_ = ij_Ap05_from_Up05__*DandX_trnUp05_tstAp05_txx_p01_V_;
if (flag_verbose); disp(sprintf(' %% fnorm(DandX_Ap05_from_trnUp05_tstAp05_txx_p01_V_(ij_Ap05_from_cap_,:) - DandX_trnUp05_tstAp05_txx_p01_V_(ij_Up05_from_cap_,:)): %0.16f',fnorm(DandX_Ap05_from_trnUp05_tstAp05_txx_p01_V_(ij_Ap05_from_cap_,:) - DandX_trnUp05_tstAp05_txx_p01_V_(ij_Up05_from_cap_,:)))); end;
%%%%;
tmp_t = tic(); if (flag_verbose); disp(sprintf(' %% xxxcluster_fromdisk_uADZSZDA_pca_proj_from_mx_ver16 ...')); end;
[ ...
 parameter_DandX_Ap05_from_trnUp05_tstAp05_txx_p01 ...
,tmp_AZnV_DandX_Ap05_from_trnUp05_tstAp05_txx_p01_ ...
,tmp_AnV_DandX_Ap05_from_trnUp05_tstAp05_txx_p01_ ...
,tmp_ZnV_DandX_Ap05_from_trnUp05_tstAp05_txx_p01_ ...
,tmp_V_ ...
] = ...
xxxcluster_fromdisk_uADZSZDA_pca_proj_from_mx_ver16( ...
 parameter_DandX_Ap05_from_trnUp05_tstAp05_txx_p01 ...
,pca_rank ...
,DandX_Ap05_from_trnUp05_tstAp05_txx_p01_V_ ...
,pca_mr_A_Ap05_ ...
,pca_mr_Z_Ap05_ ...
,pca_mc_A_Ap05 ...
,pca_str_infix_Ap05 ...
...
AZnV_DandX_Ap05_from_trnUp05_tstAp05_txx_p01_pnt___(:,:,1+np_threshold) = tmp_AZnV_DandX_Ap05_from_trnUp05_tstAp05_txx_p01_;
%%%%%%%%;
...
mr_dvx_trnUp05_tstAp05_ = 0.0*mx_Up05__.mr_A_full_;
mr_dvx_trnUp05_tstAp05_(1+efind(mx_Up05__.mr_Z_full_)) = 1; %<-- color ctrl-patients. ;
mr_dvx_trnUp05_tstAp05_(1+efind(mx_Up05__.mr_A_full_)) = 2; %<-- color case-patients. ;
mr_dvx_Ap05_from_trnUp05_tstAp05_ = 0.0*mx_Ap05__.mr_A_full_;
mr_dvx_Ap05_from_trnUp05_tstAp05_(1+efind(mx_Ap05__.mr_Z_full_)) = 1; %<-- color ctrl-patients. ;
mr_dvx_Ap05_from_trnUp05_tstAp05_(1+efind(mx_Ap05__.mr_A_full_)) = 2; %<-- color case-patients. ;
p_row = 4; p_col = n_p_threshold;
for np_threshold=0:n_p_threshold-1;
pcol = np_threshold;
p_threshold = p_threshold_(1+np_threshold);
str_p_threshold = sprintf('%.2d',min(99,floor(100*p_threshold)));
AZnV_DandX_Ap05_from_trnUp05_tstAp05_txx_p01_pn__ = AZnV_DandX_Ap05_from_trnUp05_tstAp05_txx_p01_pnt___(:,:,1+np_threshold);
AZnV_DandX_trnUp05_tstAp05_txx_p01_pn__ = AZnV_DandX_trnUp05_tstAp05_txx_p01_pnt___(:,:,1+np_threshold);
AZnV_0_min = min(min(AZnV_DandX_Ap05_from_trnUp05_tstAp05_txx_p01_pn__(:,1+0)),min(AZnV_DandX_trnUp05_tstAp05_txx_p01_pn__(:,1+0)));
AZnV_0_max = max(max(AZnV_DandX_Ap05_from_trnUp05_tstAp05_txx_p01_pn__(:,1+0)),max(AZnV_DandX_trnUp05_tstAp05_txx_p01_pn__(:,1+0)));
AZnV_0_lim_ = [AZnV_0_min,AZnV_0_max]; AZnV_0_lim_ = mean(AZnV_0_lim_) + 1.25*0.5*diff(AZnV_0_lim_)*[-1,+1];
AZnV_1_min = min(min(AZnV_DandX_Ap05_from_trnUp05_tstAp05_txx_p01_pn__(:,1+1)),min(AZnV_DandX_trnUp05_tstAp05_txx_p01_pn__(:,1+1)));
AZnV_1_max = max(max(AZnV_DandX_Ap05_from_trnUp05_tstAp05_txx_p01_pn__(:,1+1)),max(AZnV_DandX_trnUp05_tstAp05_txx_p01_pn__(:,1+1)));
AZnV_1_lim_ = [AZnV_1_min,AZnV_1_max]; AZnV_1_lim_ = mean(AZnV_1_lim_) + 1.25*0.5*diff(AZnV_1_lim_)*[-1,+1];
for prow=0:p_row-1;
if prow==0; tmp_pn__ = AZnV_DandX_Ap05_from_trnUp05_tstAp05_txx_p01_pn__; tmp_str_0 = 'Ap05'; end;
if prow==1; tmp_pn__ = AZnV_DandX_Ap05_from_trnUp05_tstAp05_txx_p01_pn__; tmp_str_0 = 'Ap05'; end;
if prow==2; tmp_pn__ = AZnV_DandX_trnUp05_tstAp05_txx_p01_pn__; tmp_str_0 = 'Up05'; end;
if prow==3; tmp_pn__ = AZnV_DandX_trnUp05_tstAp05_txx_p01_pn__; tmp_str_0 = 'Up05'; end;
if prow==0; tmp_p_ = mr_dvx_Ap05_from_trnUp05_tstAp05_; tmp_str_1 = 'DvX'; tmp_p_min = 1; tmp_p_max = 2; end;
if prow==1; tmp_p_ = mr_Ap05_p01_continent_; tmp_str_1 = 'continent'; tmp_p_min = 0; tmp_p_max = 2; end;
if prow==2; tmp_p_ = mr_dvx_trnUp05_tstAp05_; tmp_str_1 = 'DvX'; tmp_p_min = 1; tmp_p_max = 2; end;
if prow==3; tmp_p_ = mr_Up05_p01_continent_; tmp_str_1 = 'continent'; tmp_p_min = 0; tmp_p_max = 2; end;
...
%%%%%%%%;
fname_fig_pre = sprintf('%s/AZnV_xxxx_trnUp05_tstAp05_txx_DandX_p01_FIGA',dir_jpg);
...
fname_fig_pre = sprintf('%s/AZnV_D_Ap05_from_trnUp05_tstAp05_nix_p01_FIGA',dir_jpg);
